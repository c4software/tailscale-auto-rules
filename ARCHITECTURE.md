...
│       │   ├── res/
│       │   └── AndroidManifest.xml
│       └── test/…/          237 tests (Robolectric, DataStore, ViewModels, Compose)
